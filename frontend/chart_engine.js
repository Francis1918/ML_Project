...
const DEFAULT_OVERLAY_VISIBILITY = Object.freeze({
  ...
  strategy_all:        false,
  strategy_supertrend: false,
  strategy_halftrend:  false,
  strategy_range:      false,
  strategy_supply:     false,
  strategy_demand:     false,
  strategy_ob:         false,
  strategy_sr:         false,
  strategy_trendlines: false,
  strategy_channels:   false,
